...
Lab 1 Solutions: Submitted by Aditya Dhara, Arunima Kayath and Peter Grabowski
...
mod.fit.Ho = glm(formula = ratio ~ Temp , family=binomial(link=logit), weights=Number, data=challenger)
